...
const commentBarrageConfig = {
	...
	lightColors:[
		['var(--lcl-white)','var(--lcl-black)'],
	],
	darkColors:[
		['var(--lcl-black)','var(--lcl-white)'],
	],
	//同时最多显示弹幕数
	maxBarrage: 1,
	//弹幕显示间隔时间，单位ms
	...
	twikooUrl: "https://twiikoo.shiqi217.com/", // https://tkapi.yisous.xyz
	//token获取见前文
	accessToken: "7097de6c11944ae68c983344aaa28176",
